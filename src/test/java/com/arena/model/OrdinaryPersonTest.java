...
public class OrdinaryPersonTest {
    ...
    public void test_ordinaryPerson_fight_each_other_should_return_right_info(){
        ...
        String beAttackedResult = ordinaryPersonA.beAttacked(6);

        assertThat(attackResult,is("普通人张三攻击了普通人李四"));
        assertThat(ordinaryPersonA.getBlood(),is(4.0));
        assertThat(beAttackedResult,is("张三受到了6.0点伤害,张三剩余生命:4.0"));
    }
    ...
    public void test_ordinaryPerson_fight_with_warrior_who_has_weapon(){
        ...
        String beAttackedResult = ordinaryPerson.beAttacked(6);

        assertThat(attackResult,is("战士张三用倚天剑攻击了普通人李四"));
        assertThat(ordinaryPerson.getBlood(),is(34.0));
        assertThat(beAttackedResult,is("李四受到了6.0点伤害,李四剩余生命:34.0"));
    }
}
